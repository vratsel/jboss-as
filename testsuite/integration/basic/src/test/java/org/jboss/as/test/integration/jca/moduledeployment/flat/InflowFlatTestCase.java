...
public class InflowFlatTestCase extends AbstractModuleDeploymentTestCase {
	...
	public static Archive<?> createDeployment() throws Exception {
		...
		ja.addClasses(InflowFlatTestCase.class,
		...
		.addAsManifestResource(new StringAsset("Dependencies: javax.inject.api,org.jboss.as.connector,org.jboss.as.controller-client,org.jboss.dmr,org.jboss.as.cli\n"), "MANIFEST.MF");

		return raa;
		
		//return createDeployment(InflowFlatTestCase.class);
	}
